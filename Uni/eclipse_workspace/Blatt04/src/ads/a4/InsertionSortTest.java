...
public class InsertionSortTest {
	...
	public void testOptimal() {
		...
		System.out.println();
		assertTrue("Compare the number of swaps "+sv.getSwap(), sv.getSwap()<=26 );
		...
		assertTrue("Compare the number of comparision "+sv.getComparison(), sv.getComparison()<=20 );
