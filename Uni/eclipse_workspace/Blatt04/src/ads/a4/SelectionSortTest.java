...
public class SelectionSortTest {
	...
	public void testOptimal() {
		...
		assertTrue("Compare the number of pass"+sv.getCount(), sv.getCount()<=9 );
		...
		System.out.println();
		assertTrue("Compare the number of swaps "+sv.getSwap(), sv.getSwap()<=5 );
		assertTrue("Compare the number of comparision "+sv.getComparison(), sv.getComparison()<=45 );
		assertTrue("Compare the number of pass"+sv.getCount(), sv.getCount()<=10);
		...
		System.out.println();
		assertTrue("Compare the number of swaps "+sv.getSwap(), sv.getSwap()<=4 );
		assertTrue("Compare the number of comparision "+sv.getComparison(), sv.getComparison()<=28 );
		...
		System.out.println();
		assertTrue("Compare the number of swaps "+sv.getSwap(), sv.getSwap()<=4 );
		assertTrue("Compare the number of comparision "+sv.getComparison(), sv.getComparison()<=15);
		...
		System.out.println();
		assertTrue("Compare the number of swaps "+sv.getSwap(), sv.getSwap()<=3 );
		assertTrue("Compare the number of comparision "+sv.getComparison(), sv.getSwap()<=10 );
